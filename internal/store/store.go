...
func Open(dsn string) (*Store, error) {
	...
	if err := db.AutoMigrate(&WAMessage{}, &WAConversation{}, &MetaConnection{}, &MetaAppConfig{}, &IGAccount{}, &WAAISetting{}, &Project{}, &ProjectAccount{}, &ProjectSales{}, &ProjectMasterName{}); err != nil {
		return nil, err
	}
